...
<head>
    ...
    <spring:url value="/assets/style/main.css" var="mainCss" />
    ...
    <meta name="apple-mobile-web-app-status-bar-/assets/style/" content="black">
...
<div class="container">
    ...
    <div class="above-game">
        ...
        <a class="next-best-move-button">Next Best Move</a>
        <a class="auto-play-button">Auto Play</a>
    </div>
